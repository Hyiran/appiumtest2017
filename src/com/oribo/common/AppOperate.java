...
public abstract class AppOperate {
    ...
    {   
		...
		try {
			...
			System.out.println("X为:"+width+"Y为："+height);
			br.close();
     ...
     */
  	...
  	{     
          ...
          driver.swipe(width / 2, height * 3 / 4, width / 2, height / 4, 2);
   ...
   */
     ...
     * @return boolean
     */
    public static boolean waitForText(int timeoutInSeconds, String... TargetText) {
   ...
   //     ((AndroidDriver) driver).scrollTo(TargetText);
    ...
    public static void waitelementexit(WebDriver driver,By by,int seconds)
    {   
    	boolean flag=true;
    	long start = System.currentTimeMillis();
