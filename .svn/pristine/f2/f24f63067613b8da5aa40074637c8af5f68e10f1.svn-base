...
public class TestResultListener extends TestListenerAdapter{
    ...
    */
	...
	public void onTestFailure(ITestResult tr) {
		...
		//截图
		TestcaseFrame.screenCapresult(TestcaseFrame.getDriver(), casename);
		logger.info("已截图，图片名为："+TestcaseFrame.scrennfilename());
		Log.logInfo("成功比列:"+tr.getMethod().getSuccessPercentage());
	...
	public void onTestStart(ITestResult result) {
		...
		Log.logInfo("groups:"+method.getGroups().length);
	...
	public void onFinish(ITestContext testContext) {
		...
		logger.info("PASSED:"+getPassedTests().size());
		logger.info("FAILED:"+getFailedTests().size());
		logger.info("SKIPPED:"+getSkippedTests().size());
